...
<body>
    ...
    <div class="main-content">
        ...
        <div class="filter-section" id="filter-section">
            <h2>Filter</h2>
            <form method="GET" action="product-aksesoris.php">
                ...
                <a href="product-aksesoris.php" class="btn-reset">Reset Filter</a>
            </form>
        </div>
    ...
    <section class="categories" id="categories">
        ...
        <div class="categories-container">
            <!--box-->
            <div class="box box1">
                <img class="fashion-active" src="img2/dark-blue-2-removebg-preview.png" alt="">
                <h2>Fashion</h2>
                <span>22 items</span>
    ...
    <section class="products" id="products">
        ...
        <div class="products-container">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<a href='product-detail-card-slider-master/product-detail.html'><i class='bx bx-cart-alt'></i></a>";
